   ...
   // public $limite;
    ...
    public function ListarTodos($params = null)
    {
        try {
            ...
            if (!is_null($params)&& !is_null($params->linha_inicial)) {
                $this->stmt->bindValue(':linha_inicial', $params->linha_inicial, PDO::PARAM_INT);
            }
            if (!is_null($params)&& !is_null($params->qtd_registros_pagina)) {
                $this->stmt->bindValue(':qtd_registros_pagina', $params->qtd_registros_pagina, PDO::PARAM_INT);
            }
