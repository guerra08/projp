<?php
    ...
    public function __construct() {
        ...
        public function Inserir($obj){
            ...
            try {
                ...
                $this->stmt= $this->conn->prepare($query);
                    ...
                    $this->stmt->bindValue(':status', 0, PDO::PARAM_STR);
        ...
        public function Alterar($obj){
            ...
            try {
                //comando sql de UPDATE
                $query= "UPDATE Imagem SET :nome,:descricao,:data_insercao,:autoria,:data_imagem,:categoria,:imagem WHERE id_imagem=:id_imagem";
                  $this->stmt= $this->conn->prepare($query);
                        $this->stmt->bindValue(':nome', $obj->getNome(), PDO::PARAM_STR);
                        $this->stmt->bindValue(':descricao', $obj->getDescricao(), PDO::PARAM_STR);
                        $this->stmt->bindValue(':data_insercao', $obj->getData_insercao(), PDO::PARAM_STR);
                        $this->stmt->bindValue(':autoria', $obj->getAutoria(), PDO::PARAM_STR);
                        $this->stmt->bindValue(':data_imagem', $obj->getData_imagem(), PDO::PARAM_STR);
       ...
       public function ListarTodos($param){
            ...
            public function countSolicitacoes($param = null){
                $sql = "SELECT COUNT(id_imagem) FROM imagem WHERE status = 0";
